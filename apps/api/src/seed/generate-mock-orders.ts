// Self-contained copy of apps/web/features/orders/server/mock-orders.ts's generator.
// Duplicated deliberately rather than shared — see specs/Auth/initial-plan.md
// (Milestone 3) for why. Keep the generation logic in sync with that file.

export const ORDER_STATUSES = ["New", "Picking", "Delivering", "Delivered"]
...
export function generateMockOrders(count: number): SeedOrder[] {
